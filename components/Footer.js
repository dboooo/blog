  ...
  return (
    <div className="flex justify-center p-1 mt-6 bg-white dark:bg-gray-900 rounded-3xl">
      <button
        ...
        className="flex items-center justify-center w-24 h-10 h-full p-2 pr-2 transition dark:bg-primary rounded-3xl align-center"
      >
        {moonIcon}
      </button>
      ...
      <button
        ...
        className="flex items-center justify-center w-24 h-10 h-full p-2 pr-2 transition bg-primary dark:bg-transparent rounded-3xl align-center"
      >
        {sunIcon}
      </button>
    </div>
